...
namespace AksharaMurda
{
    public class PlayerMotor : MonoBehaviour
    {
        ...
        public void OnHit(Hit hit)
        {
            ...
            GameObject.FindObjectOfType<PlayerBlood>().OnHit();

            CameraShaker.Instance.ShakeOnce(0.2f, 5f, 0.5f, 0.5f);
            if (IK.HitBone == null)
                return;
        ...
        {
            PlayerCharacter.Unregister(this);
        ...
        private void updateCornerAim()
        {
            ...
            _currentMovement = new PlayerMovement();
